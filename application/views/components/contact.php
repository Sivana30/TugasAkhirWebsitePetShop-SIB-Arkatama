...
<body>
  ...
  <section class="contact">
    ...
    <form action="<?=base_url('Landing_page/contact')?>" method="post">
      ...
      <input type="text" name="addmessage[name]" placeholder="Nama" required maxlength="20" class="box">
      <input type="email" name="addmessage[email]" placeholder="Email" required maxlength="50" class="box">
      <input type="number" name="addmessage[number]" placeholder="Nomor hp" required  min="0" max="9999999999"
        onkeypress="if(this.value.length == 10) return false;" class="box">
      <textarea name="addmessage[message]" placeholder="Isi Pesan" class="box" cols="30" rows="10"></textarea>
